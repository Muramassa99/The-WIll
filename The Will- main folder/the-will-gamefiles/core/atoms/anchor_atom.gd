...
@export var span_slice_center_positions_origin_id: StringName = DEFAULT_ANCHOR_ORIGIN_ID
...
func normalize() -> void:
	...
	if span_slice_center_positions_origin_id == StringName():
		span_slice_center_positions_origin_id = DEFAULT_ANCHOR_ORIGIN_ID
