...
@export var grid_size: Vector3i = Vector3i(480, 160, 80)
@export var melee_grid_size: Vector3i = Vector3i(480, 160, 80)
@export var ranged_physical_grid_size: Vector3i = Vector3i(320, 160, 60)
@export var shield_grid_size: Vector3i = Vector3i(200, 160, 60)
@export var magic_grid_size: Vector3i = Vector3i(200, 60, 60)
@export var ranged_physical_quiver_grid_size: Vector3i = Vector3i(140, 60, 60)
@export_range(0.001, 1.0, 0.001) var cell_world_size_meters: float = 0.0125
...
@export var primary_grip_min_length_voxels: int = 20
...
@export var primary_grip_two_hand_min_length_voxels: int = 26
@export var primary_grip_slice_clearance_voxels: int = 1
@export var primary_grip_slice_max_drift_voxels: int = 1
@export var primary_grip_slice_max_profile_span_voxels: int = 5
...
@export var joint_min_cross_width_voxels: int = 4
@export var joint_min_cross_thickness_voxels: int = 4
@export var joint_min_length_voxels: int = 8
...
@export var riser_min_compact_cross_span_voxels: int = 4
@export var riser_max_length_voxels: int = 8
@export_range(0.0, 1.0, 0.01) var bow_string_min_support_material_ratio: float = 0.80
@export var bow_string_max_cross_span_voxels: int = 2
@export var bow_string_min_length_voxels: int = 6
@export_range(0.0, 1.0, 0.01) var projectile_min_support_material_ratio: float = 0.50

@export_group("Bow Rules")
@export var bow_string_required_cross_span_voxels: int = 2
@export var bow_limb_min_cross_width_voxels: int = 4
@export var bow_limb_min_cross_thickness_voxels: int = 4
@export var bow_limb_min_length_voxels: int = 8
@export_range(0.05, 2.0, 0.01) var bow_string_draw_distance_meters: float = 0.45
@export_range(0.1, 32.0, 0.1) var bow_limb_flex_length_reference_voxels: float = 16.0
...
@export_range(0.0, 16.0, 0.1) var stage2_primary_grip_safe_radius_voxels: float = 5.0
...
@export_range(0.01, 1.0, 0.01) var stage2_tool_min_amount_ratio: float = 0.05
@export_range(0.01, 1.0, 0.01) var stage2_tool_max_amount_ratio: float = 1.0
@export_range(0.01, 1.0, 0.01) var stage2_tool_amount_ratio_step: float = 0.05
