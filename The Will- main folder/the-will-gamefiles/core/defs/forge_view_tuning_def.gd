...
@export var workspace_zoom_step: float = 0.1
@export var workspace_zoom_min_distance: float = 0.1
@export var workspace_zoom_max_distance: float = 6.0
@export var workspace_fit_distance_multiplier: float = 1.2
@export var workspace_fit_min_distance: float = 1.5
@export var workspace_fit_max_distance: float = 6.0
...
@export var workspace_stage2_shell_color: Color = Color(0.392157, 0.176471, 0.568627, 0.62)
@export var workspace_stage2_brush_color: Color = Color(0.392157, 0.176471, 0.568627, 0.22)
@export var workspace_stage2_blocked_brush_color: Color = Color(0.780392, 0.25098, 0.309804, 0.18)
@export var workspace_stage2_hover_face_color: Color = Color(0.392157, 0.176471, 0.568627, 0.38)
@export var workspace_stage2_selected_face_color: Color = Color(0.392157, 0.176471, 0.568627, 0.56)
