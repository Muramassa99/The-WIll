...
const ORIGIN_PRIMARY_GRIP_CONTACT_SURFACE: StringName = &"PrimaryGripContactSurfaceOrigin"
const ORIGIN_SUPPORT_GRIP_CONTACT_SURFACE: StringName = &"SupportGripContactSurfaceOrigin"
