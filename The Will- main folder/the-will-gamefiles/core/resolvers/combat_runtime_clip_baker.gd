...
func _clear_frame_data(clip) -> void:
	...
	clip.baked_right_hand_proxy_authored.clear()
	clip.baked_right_hand_proxy_tip_positions_local.clear()
	clip.baked_right_hand_proxy_pommel_positions_local.clear()
	clip.baked_left_hand_proxy_authored.clear()
	clip.baked_left_hand_proxy_tip_positions_local.clear()
	clip.baked_left_hand_proxy_pommel_positions_local.clear()
...
func _append_chain_player_frame(
	...
	clip.baked_right_hand_proxy_authored.append(chain_player.current_right_hand_proxy_authored)
	clip.baked_right_hand_proxy_tip_positions_local.append(chain_player.current_right_hand_proxy_tip_position)
	clip.baked_right_hand_proxy_pommel_positions_local.append(chain_player.current_right_hand_proxy_pommel_position)
	clip.baked_left_hand_proxy_authored.append(chain_player.current_left_hand_proxy_authored)
	clip.baked_left_hand_proxy_tip_positions_local.append(chain_player.current_left_hand_proxy_tip_position)
	clip.baked_left_hand_proxy_pommel_positions_local.append(chain_player.current_left_hand_proxy_pommel_position)
...
func _append_motion_node_frame(
	...
	clip.baked_right_hand_proxy_authored.append(motion_node.right_hand_proxy_authored)
	clip.baked_right_hand_proxy_tip_positions_local.append(motion_node.right_hand_proxy_tip_position_local)
	clip.baked_right_hand_proxy_pommel_positions_local.append(motion_node.right_hand_proxy_pommel_position_local)
	clip.baked_left_hand_proxy_authored.append(motion_node.left_hand_proxy_authored)
	clip.baked_left_hand_proxy_tip_positions_local.append(motion_node.left_hand_proxy_tip_position_local)
	clip.baked_left_hand_proxy_pommel_positions_local.append(motion_node.left_hand_proxy_pommel_position_local)
