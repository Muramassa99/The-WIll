...
func _run_verification() -> void:
	...
	lines.append("focus_cycle_ok=%s" % str(
		...
		and focus_after_three_cycles == CombatAnimationSessionStateScript.FOCUS_RIGHT_ARM_ROLL
		and focus_after_four_cycles == CombatAnimationSessionStateScript.FOCUS_LEFT_ARM_ROLL
	))
