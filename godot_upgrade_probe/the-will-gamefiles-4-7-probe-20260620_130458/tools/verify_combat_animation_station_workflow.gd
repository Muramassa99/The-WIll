...
func _run_verification() -> void:
	...
	var active_draft_after_manual_save: Resource = ui.call("_get_active_draft") as Resource
	var runtime_clip_after_manual_save = active_draft_after_manual_save.get("baked_runtime_clip") if active_draft_after_manual_save != null else null
	var runtime_clip_frame_count_after_manual_save: int = (
		int(runtime_clip_after_manual_save.call("get_frame_count"))
		if runtime_clip_after_manual_save != null and runtime_clip_after_manual_save.has_method("get_frame_count")
		else -1
	)
	var active_draft_has_valid_cache_after_manual_save: bool = bool(ui.call("_active_draft_has_valid_preview_cache", active_draft_after_manual_save))
	var requires_save_after_manual_save: bool = bool(ui.call("_active_draft_requires_manual_save"))
	var play_button_enabled_after_manual_save: bool = ui.play_preview_button != null and not ui.play_preview_button.disabled
	ui.call("_toggle_preview_playback")
	await process_frame
	var preview_playing_after_manual_save: bool = ui.chain_player.is_playing()
	if preview_playing_after_manual_save:
		ui.call("_toggle_preview_playback")
		await process_frame
	...
	lines.append("runtime_clip_frame_count_after_manual_save=%d" % runtime_clip_frame_count_after_manual_save)
	lines.append("active_draft_has_valid_cache_after_manual_save=%s" % str(active_draft_has_valid_cache_after_manual_save))
	lines.append("requires_save_after_manual_save=%s" % str(requires_save_after_manual_save))
	lines.append("play_button_enabled_after_manual_save=%s" % str(play_button_enabled_after_manual_save))
	lines.append("preview_playing_after_manual_save=%s" % str(preview_playing_after_manual_save))
