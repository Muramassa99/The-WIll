...
func _run_verification() -> void:
	...
	var rectangle_overlay_primary_visible: bool = crafting_ui.shape_primary_size_overlay_row.visible
	var rectangle_overlay_secondary_visible: bool = crafting_ui.shape_secondary_size_overlay_row.visible
	var rectangle_overlay_primary_up_text_ok: bool = crafting_ui.shape_primary_size_up_button.text == "Width +"
	var rectangle_overlay_primary_down_text_ok: bool = crafting_ui.shape_primary_size_down_button.text == "Width -"
	var rectangle_overlay_secondary_up_text_ok: bool = crafting_ui.shape_secondary_size_up_button.text == "Height +"
	var rectangle_overlay_secondary_down_text_ok: bool = crafting_ui.shape_secondary_size_down_button.text == "Height -"
	var rectangle_size_a_before_overlay: int = crafting_ui.rectangle_shape_size_a_cells
	var rectangle_size_b_before_overlay: int = crafting_ui.rectangle_shape_size_b_cells
	crafting_ui.shape_primary_size_up_button.emit_signal("pressed")
	crafting_ui.shape_secondary_size_up_button.emit_signal("pressed")
	await process_frame
	var rectangle_overlay_primary_button_increased: bool = crafting_ui.rectangle_shape_size_a_cells == rectangle_size_a_before_overlay + 1
	var rectangle_overlay_secondary_button_increased: bool = crafting_ui.rectangle_shape_size_b_cells == rectangle_size_b_before_overlay + 1
	...
	await process_frame
	var circle_overlay_primary_visible: bool = crafting_ui.shape_primary_size_overlay_row.visible
	var circle_overlay_secondary_hidden: bool = not crafting_ui.shape_secondary_size_overlay_row.visible
	var circle_overlay_primary_up_text_ok: bool = crafting_ui.shape_primary_size_up_button.text == "+"
	var circle_overlay_primary_down_text_ok: bool = crafting_ui.shape_primary_size_down_button.text == "-"
	var circle_radius_before_overlay: int = crafting_ui.circle_shape_radius_cells
	crafting_ui.shape_primary_size_up_button.emit_signal("pressed")
	await process_frame
	var circle_overlay_primary_button_increased: bool = crafting_ui.circle_shape_radius_cells == circle_radius_before_overlay + 1
	crafting_ui.call("_step_stage1_shape_primary_size", 2)
	await process_frame
	...
	lines.append("rectangle_overlay_primary_visible=%s" % str(rectangle_overlay_primary_visible))
	lines.append("rectangle_overlay_secondary_visible=%s" % str(rectangle_overlay_secondary_visible))
	lines.append("rectangle_overlay_primary_up_text_ok=%s" % str(rectangle_overlay_primary_up_text_ok))
	lines.append("rectangle_overlay_primary_down_text_ok=%s" % str(rectangle_overlay_primary_down_text_ok))
	lines.append("rectangle_overlay_secondary_up_text_ok=%s" % str(rectangle_overlay_secondary_up_text_ok))
	lines.append("rectangle_overlay_secondary_down_text_ok=%s" % str(rectangle_overlay_secondary_down_text_ok))
	lines.append("rectangle_overlay_primary_button_increased=%s" % str(rectangle_overlay_primary_button_increased))
	lines.append("rectangle_overlay_secondary_button_increased=%s" % str(rectangle_overlay_secondary_button_increased))
	...
	lines.append("circle_overlay_primary_visible=%s" % str(circle_overlay_primary_visible))
	lines.append("circle_overlay_secondary_hidden=%s" % str(circle_overlay_secondary_hidden))
	lines.append("circle_overlay_primary_up_text_ok=%s" % str(circle_overlay_primary_up_text_ok))
	lines.append("circle_overlay_primary_down_text_ok=%s" % str(circle_overlay_primary_down_text_ok))
	lines.append("circle_overlay_primary_button_increased=%s" % str(circle_overlay_primary_button_increased))
