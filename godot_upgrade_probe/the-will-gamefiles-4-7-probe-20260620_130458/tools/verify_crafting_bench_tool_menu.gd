...
func _run_verification() -> void:
	...
	var rectangle_tool_menu_has_rotate_left: bool = _popup_has_item_text(tool_popup, "Rotate Shape -5 deg")
	var rectangle_tool_menu_has_rotate_right: bool = _popup_has_item_text(tool_popup, "Rotate Shape +5 deg")
	var rectangle_tool_menu_rotate_left_enabled: bool = not _popup_item_disabled(tool_popup, "Rotate Shape -5 deg")
	var rectangle_tool_menu_rotate_right_enabled: bool = not _popup_item_disabled(tool_popup, "Rotate Shape +5 deg")
	...
	await process_frame
	crafting_ui.call("_rebuild_tool_menu")
	var rectangle_rotation_changed_to_five: bool = _popup_has_item_text(tool_popup, "Rotation: 5 deg")
	var tool_popup_visible_after_shape_rotate: bool = tool_popup.visible
	crafting_ui.call("_on_action_menu_id_pressed", int(menu_ids.get("tool_shape_rotate_right", -1)))
	await process_frame
	await process_frame
	crafting_ui.call("_rebuild_tool_menu")
	var rectangle_rotation_changed_to_ten: bool = _popup_has_item_text(tool_popup, "Rotation: 10 deg")
	var tool_popup_visible_after_repeated_shape_rotate: bool = tool_popup.visible

	crafting_ui.call("_set_active_tool", ForgeWorkspaceShapeToolPresenterScript.FAMILY_SPLINE_LINE)
	await process_frame
	crafting_ui.call("_rebuild_tool_menu")
	var spline_tool_menu_has_shape_line: bool = _popup_has_item_text(tool_popup, "Shape Tool: Spline Line")
	var spline_tool_menu_has_width_line: bool = _popup_contains_prefix(tool_popup, "Line Width: ")
	var spline_tool_menu_has_width_down: bool = _popup_has_item_text(tool_popup, "Width -")
	var spline_tool_menu_has_width_up: bool = _popup_has_item_text(tool_popup, "Width +")
	var spline_tool_menu_has_line_end_option: bool = _popup_contains_prefix(tool_popup, "Line End Option: ")
	var spline_tool_menu_has_square_end: bool = _popup_has_item_text(tool_popup, "Square End")
	var spline_tool_menu_has_rounded_end: bool = _popup_has_item_text(tool_popup, "Rounded End")
	var spline_tool_menu_hides_rotation: bool = not _popup_contains_prefix(tool_popup, "Rotation: ")
	_open_tool_popup(crafting_ui)
	await process_frame
	crafting_ui.call("_on_action_menu_id_pressed", int(menu_ids.get("tool_shape_primary_up", -1)))
	await process_frame
	crafting_ui.call("_rebuild_tool_menu")
	var spline_width_changed_to_two: bool = _popup_has_item_text(tool_popup, "Line Width: 2 cells")
	var tool_popup_visible_after_spline_width: bool = tool_popup.visible
	crafting_ui.call("_on_action_menu_id_pressed", int(menu_ids.get("tool_spline_end_cap_square", -1)))
	await process_frame
	crafting_ui.call("_rebuild_tool_menu")
	var spline_square_end_selected: bool = _popup_has_item_text(tool_popup, "Line End Option: Square")
	...
	lines.append("rectangle_rotation_changed_to_five=%s" % str(rectangle_rotation_changed_to_five))
	lines.append("tool_popup_visible_after_shape_rotate=%s" % str(tool_popup_visible_after_shape_rotate))
	lines.append("rectangle_rotation_changed_to_ten=%s" % str(rectangle_rotation_changed_to_ten))
	lines.append("tool_popup_visible_after_repeated_shape_rotate=%s" % str(tool_popup_visible_after_repeated_shape_rotate))
	lines.append("spline_tool_menu_has_shape_line=%s" % str(spline_tool_menu_has_shape_line))
	lines.append("spline_tool_menu_has_width_line=%s" % str(spline_tool_menu_has_width_line))
	lines.append("spline_tool_menu_has_width_down=%s" % str(spline_tool_menu_has_width_down))
	lines.append("spline_tool_menu_has_width_up=%s" % str(spline_tool_menu_has_width_up))
	lines.append("spline_tool_menu_has_line_end_option=%s" % str(spline_tool_menu_has_line_end_option))
	lines.append("spline_tool_menu_has_square_end=%s" % str(spline_tool_menu_has_square_end))
	lines.append("spline_tool_menu_has_rounded_end=%s" % str(spline_tool_menu_has_rounded_end))
	lines.append("spline_tool_menu_hides_rotation=%s" % str(spline_tool_menu_hides_rotation))
	lines.append("spline_width_changed_to_two=%s" % str(spline_width_changed_to_two))
	lines.append("tool_popup_visible_after_spline_width=%s" % str(tool_popup_visible_after_spline_width))
	lines.append("spline_square_end_selected=%s" % str(spline_square_end_selected))
