...
func _run_verification() -> void:
	...
	var forearm_pair_exempt: bool = bool(solver.call(
		"_body_proxy_pair_allows_anatomical_overlap",
		{"region": "left_forearm"},
		{"region": "right_forearm"},
		-1.0
	))
	var chest_forearm_deep_overlap_exempt: bool = bool(solver.call(
		"_body_proxy_pair_allows_anatomical_overlap",
		{"region": "torso_chest"},
		{"region": "right_forearm"},
		-1.0
	...
	lines.append("forearm_pair_exempt=%s" % str(forearm_pair_exempt))
	lines.append("chest_forearm_deep_overlap_exempt=%s" % str(chest_forearm_deep_overlap_exempt))
	...
	lines.append("anatomical_self_collision_ok=%s" % str(
		...
		and forearm_pair_exempt
		and not chest_forearm_deep_overlap_exempt
