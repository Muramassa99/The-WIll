...
const RESULT_FILE_PATH := "C:/WORKSPACE/stage2_feature_band_restore_results.txt"
...
func _run_verification() -> void:
	...
	crafting_ui.open_for(player, forge_controller, "Stage2 Feature Band Restore Bench")
	await process_frame
	await process_frame
	...
	var feature_band_restore_hidden: bool = not _popup_has_item_text(geometry_popup, "Feature Band Restore Tool")
...
func _build_front_heavy_sword_wip() -> CraftedItemWIP:
	...
	wip.wip_id = &"verify_stage2_feature_band_restore_front_heavy_sword"
	wip.forge_project_name = "Verify Stage2 Feature Band Restore Front Heavy Sword"
